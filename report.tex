...
\begin{titlepage}
    ...
    \begin{tabular}{>{\centering}m{0.3\textwidth} >{\centering}m{0.3\textwidth} >{\centering\arraybackslash}m{0.3\textwidth}}
        {\large Akim Komarnitskii} & {\large Jeet Meher} & {\large Ollie Vahid} \\
        [0.75cm]
        {\large Alex Herrera} & {\large Kateryna Dzemliuk} & {\large Tom Boyce} \\
        [0.75cm]
        {\large James Sheppard} & {\large Martin Darwall} & {\large Chien Nguyen} \\
    \end{tabular}
