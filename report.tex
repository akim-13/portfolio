...
\subsection{Gathering System Requirements - SRQ 2.3, 3}
...
\subsection{Specific Domain of Application - SRQ 2.1}
...
\subsection{Data Fields Chosen - SRQ 2.1, 5.3}
...
\begin{itemize}
    ...
    \item \textbf{Achievements and Goals - ARQ 1}: These will be the methods by which goals for a
...
\subsection{Motivating Users - SRQ 7, ARQ 1}
...
\subsection{Comparing User Data - SRQ 5.2, 6}
...
\subsection{Viewing and Collecting Tracking Data - SRQ 5.1/2/3}
...
\subsection{Scalability and Performance - ARQ 2, 3}

Scalability (ARQ 2) will not be a problem for our system as it runs entirely off of the
user's computer.
...
a user's experience (ARQ 3).


\subsection{Structuring the Software Development Process - SRQ 1}
...
\subsection{Table of Requirements, Dependencies, and Priorities}
\begin{table}[h!]
\centering
\begin{tabular}{c|c|c|}
	\hline

	\textbf{requirement (RQ)} & \textbf{Dependencies} & \textbf{Priority} \\ \hline
	
	SRQ 1 - Software development process & N/A & High/Medium \\ \hline
	SRQ 2.1 Expand on initital requirements & 3.2 & High \\ \hline
	SRQ 2.3 - Establish additional requirements & 2.1, 2.2 & High \\ \hline
	SRQ 3 - Background research & N/A & High \\ \hline
	SRQ 4 - Testing & N/A & High \\ \hline
	SRQ 5.1 - Store relevant user data & 3 & High \\ \hline
	SRQ 5.2 - Allow users to access data & N/A & High \\ \hline
	SRQ 5.3 - Allow for manual data entry & N/A & Medium \\ \hline
	SRQ 6 - Identify trends and relationships & 3, 5.1 & High \\ \hline
	SRQ 7.1 - Allow for managing of goals & 5.1 & High \\ \hline
	SRQ 7.2 - Allow goals to be set over a given time frame & 5.1, 7.1 & Medium \\ \hline
	SRQ 7.3 - Allow for updating of a goal & 7.1 & Low \\ \hline
	SRQ 7.4  - motivating features & 7.1 & Medium \\ \hline
	ARQ 1 - Social features & N/A & High \\ \hline
	ARQ 2 - Create a scalable system & N/A & Medium \\ \hline
	ARQ 3 - System must  run smoothly & N/A & Low \\ \hline
