...
\begin{itemize}
    ...
    \item \texttt{UserAchievements} Table: This table is used to store the 
	achievements for every user. By using a compound 
	key of the \texttt{Username}, \texttt{Date}, and \texttt{ActivityID} fields each achievement can be uniquely stored.
	 These fields also allow for the comparison of the accomplishments
	of a user across a given activity or timeframe. The \texttt{Timeframe} 
	and \texttt{Value} fields are also essential as they contain vital data
	 to each achievement: What a user must achieve and by when. This 
        table adheres to SRQ 7.4. and  SRQ 7.1.\par
