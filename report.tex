...
discussed and a Test Plan was created,  Figure \ref{fig:TestDesign} . It was agreed that each time a developer completed a feature from the
...
and fix the problem before applying all tests again.  If the error was found in anothers developers code,  the error and the test results were provided to the person responisble and they would colaborate on the debugging.  In this way, the component's
...
\begin{figure}[!ht]
  \centering
  \includegraphics[width = 1\linewidth]{Test Design}
